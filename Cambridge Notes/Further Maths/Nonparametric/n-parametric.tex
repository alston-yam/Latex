...
\begin{document}
    ...
    We do this test when the two independent groups have data that aren't normally distributed, and also when there are two samples of different sizes. We first treat them as one big group and then rank their sizes. Then we sum the ranks of each individual group. 
